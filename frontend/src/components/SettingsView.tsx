  ...
  return (
    <section className="settings-page">
      ...
      <div className="settings-card">
        ...
        <label className="settings-select-row"><span><strong>Remote Control</strong><small>Start new Terminal Claude sessions with Remote Control available through claude.ai and mobile. Rich sessions use Claude’s structured interface and cannot run `/rc`.</small></span><select value={props.claudeSettings.remoteControl} disabled={props.claudeBusy || !props.claudeAvailable} onChange={(event) => void props.onClaudeSettings({ ...props.claudeSettings, remoteControl: event.currentTarget.value as ClaudeSettings['remoteControl'] })}><option value="inherit">Inherit from Claude</option><option value="on">On for new Terminal sessions</option><option value="off">Off</option></select></label>
