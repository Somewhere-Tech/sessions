...
var commandTable = []commandSpec{
	...
	{
		name: "history", aliases: []string{"conversations"}, usage: "history [QUERY] [--since WHEN] [--until WHEN] [--tool claude|codex|shell] [--surface SURFACE] [--actor user|automation|agent] [--cwd PATH] [--name GLOB] [--session ID[,ID...]] [--preview [N]] [-n N] [--all] [--json]",
		...
		examples: []string{"sessions history", "sessions history --since today --tool codex", "sessions history --surface codex-desktop", "sessions history --actor automation --since 1w", "sessions history --preview -n 3", "sessions history 'sessions hardening' --tool codex", "sessions history --cwd . --since 1w", "sessions --json history --since yesterday"},
		run:      (*app).cmdHistory,
	},
	{
