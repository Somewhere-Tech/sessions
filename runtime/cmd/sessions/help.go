...
var commandTable = []commandSpec{
	...
	},
	{
		...
		summary: "inspect user onboarding and Remote Control consent", group: dailyCommandGroup, localJSON: true,
		longHelp: "Show whether this machine has completed Sessions onboarding and whether Claude Remote Control is enabled. This command is deliberately read-only: an agent can explain the state but cannot grant user consent. Open Sessions.app to make or change the choice.",
