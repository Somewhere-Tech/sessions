...
var commandTable = []commandSpec{
	...
	{
		name: "history", aliases: []string{"conversations"}, usage: "history [QUERY] [--since WHEN] [--until WHEN] [--tool claude|codex|shell] [--cwd PATH] [--name GLOB] [--session ID[,ID...]] [--preview [N]] [-n N] [--all] [--json]",
		...
		examples: []string{"sessions history", "sessions history --since today --tool codex", "sessions history --preview -n 3", "sessions history 'sessions hardening' --tool codex", "sessions history --cwd . --since 1w", "sessions --json history --since yesterday"},
		run:      (*app).cmdHistory,
	},
	{
