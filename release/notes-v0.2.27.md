...
- Routes a non-autonomous Codex lane's permission requests through Sessions instead of accepting them silently: the lane waits, shows as needing you, and is answered with Allow / Allow for this session / Decline in the app, `sessions approve <id>`, or the API. The answer is recorded in the lane's transcript with who gave it.
